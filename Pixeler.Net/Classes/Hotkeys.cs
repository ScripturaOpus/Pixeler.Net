...
internal class GlobalHotkeys
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GlobalHotkeys"/> class and installs the keyboard hook.
    /// </summary>
    ...
    /// <see cref="GlobalHotkeys"/> is reclaimed by garbage collection and uninstalls the keyboard hook.
    /// </summary>
    ~GlobalHotkeys()
    {
        unhook();
